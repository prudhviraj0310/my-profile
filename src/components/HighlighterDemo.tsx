                            ...
                            <div className="flex justify-center">
                                <div className="flex h-full flex-col justify-center gap-10 p-4 md:h-[300px] md:flex-row">
                                    <div
                                        ...
                                        ref={scope}
                                    >
                                        <Palette className="absolute left-1/2 top-1/2 h-6 w-6 -translate-x-1/2 -translate-y-1/2 text-accent" />
                                        <div
                                            id="next-js"
                                        ...
                                        <div id="pointer" className="absolute">
                                            ...
                                            <span className="bg-ali relative -top-1 left-3 rounded-3xl px-2 py-1 text-xs text-white bg-red-500">
                                                Ali
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="-mt-20 flex h-full flex-col justify-center p-2 md:-mt-4 md:ml-10 md:w-[400px]">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            ...
                                            <a
                                                href="mailto:prudhvinaik2005@gmail.com"
                                                className={cn(
                                                    buttonVariants({
                                                        variant: "outline",
                                                        size: "icon",
